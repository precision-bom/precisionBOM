...
echo "  2. Three AI agents reviewing parts: Engineering → Sourcing → Finance"
...
echo -e "${WHITE}  │   EngineeringAgent → SourcingAgent → FinanceAgent              │${NC}"
echo -e "${WHITE}  │              (Claude API for LLM reasoning)                     │${NC}"
echo -e "${WHITE}  └─────────────────────────────────────────────────────────────────┘${NC}"
echo ""
...
echo "  ${WHITE}┌────────────┐   ┌────────────┐   ┌────────────┐   ┌────────────┐${NC}"
echo "  ${WHITE}│   INTAKE   │ → │  ENRICH    │ → │ ENGINEERING│ → │  SOURCING  │${NC}"
echo "  ${WHITE}│ Parse BOM  │   │ Get Offers │   │   REVIEW   │   │   REVIEW   │${NC}"
echo "  ${WHITE}└────────────┘   └────────────┘   └────────────┘   └────────────┘${NC}"
echo "                                                                  │"
echo "                                                                  ▼"
echo "                                              ${WHITE}┌────────────┐   ┌────────────┐${NC}"
echo "                                              ${WHITE}│  FINANCE   │ → │  COMPLETE  │${NC}"
echo "                                              ${WHITE}│   REVIEW   │   │            │${NC}"
echo "                                              ${WHITE}└────────────┘   └────────────┘${NC}"
echo ""

explain "Each agent has a specific role:"
echo ""
echo "  ${CYAN}EngineeringAgent:${NC}"
...
echo "  ${GREEN}✓${NC} BOM processing through agent pipeline"
