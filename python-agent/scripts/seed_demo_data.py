...
def seed_parts(store: OrgKnowledgeStore) -> None:
    ...
    parts = [
        ...
        PartKnowledge(
            ...
            preferred=True,
            last_used_date=date(2025, 1, 5),
            projects_used_in=["PRJ-2024-015", "PRJ-2024-022", "PRJ-2025-001"],
            times_used=15,
            failure_count=0,
        ),
        PartKnowledge(
        ...
        PartKnowledge(
            ...
            projects_used_in=["PRJ-2024-018", "PRJ-2025-001"],
            times_used=8,
            failure_count=0,
        ),
        PartKnowledge(
            ...
            preferred=True,
            last_used_date=date(2025, 1, 8),
            projects_used_in=["PRJ-2024-010", "PRJ-2024-015", "PRJ-2024-022", "PRJ-2025-001"],
            times_used=22,
            failure_count=0,
        ),
        # MCU
        PartKnowledge(
            ...
            projects_used_in=["PRJ-2024-005", "PRJ-2025-001"],
            times_used=5,
            failure_count=0,
        ...
        PartKnowledge(
            ...
            projects_used_in=["PRJ-2024-008", "PRJ-2025-001"],
            times_used=10,
            failure_count=1,
        ...
        PartKnowledge(
            ...
            projects_used_in=["PRJ-2024-003", "PRJ-2025-001"],
            times_used=12,
            failure_count=0,
        ),
        PartKnowledge(
        ...
        PartKnowledge(
            ...
            projects_used_in=["PRJ-2024-010", "PRJ-2025-001"],
            times_used=14,
            failure_count=0,
        ),
        # Banned part example
